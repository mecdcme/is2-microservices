...
CREATE TABLE is2.is2_workflow_status (
  id integer NOT NULL,
  work_session_id integer NOT NULL,
  business_function_id integer NOT NULL,
  status integer NOT NULL,
  creationDate timestamp without time zone NOT NULL,
  creatorUser character varying(100) DEFAULT NULL::character varying,
  modifyDate timestamp without time zone ,
  modifierUser character varying(100) DEFAULT NULL::character varying
);


-- is2.is2_workflow_status_history definition

CREATE TABLE is2.is2_workflow_status_history (
  id integer NOT NULL ,
...
CREATE SEQUENCE is2.is2_workflow_status_seq
  AS integer
  START WITH 1
  INCREMENT BY 1
  NO MINVALUE
...
CREATE SEQUENCE is2.is2_workflow_status_history_seq
  AS integer
  START WITH 1
  INCREMENT BY 1
  NO MINVALUE
...
ALTER SEQUENCE is2.is2_workflow_status_seq OWNED BY is2.is2_workflow_status.id;
ALTER SEQUENCE is2.is2_workflow_status_history_seq OWNED BY is2.is2_workflow_status_history.id;

ALTER TABLE ONLY is2.is2_workflow_status ALTER COLUMN id SET DEFAULT nextval('is2.is2_workflow_status_seq'::regclass);
ALTER TABLE ONLY is2.is2_workflow_status_history ALTER COLUMN id SET DEFAULT nextval('is2.is2_workflow_status_history_seq'::regclass);
